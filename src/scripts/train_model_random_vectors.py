...
from utils.custom_datasets import RandomVectorsDataset
...
def main():
    ...
    train_dataset = RandomVectorsDataset(
        dim=args.backbone_model_output_dim,
        len=2500000,
        dtype=torch.float32
    )
    val_dataset = RandomVectorsDataset(
        dim=args.backbone_model_output_dim,
        len=250000,
        dtype=torch.float32
    )
